...
\begin{siglas}
    ...
    \item[PMC] Perceptron Multicamadas
    \item[VSS] IEEE Very Small Size
    \item[VSSS] IEEE Very Small Size Soccer
...
% ---
\include{cap/USPSC-Cap1-Introducao}
\include{cap/USPSC-Cap2-FundamentosTeoricos}
\include{cap/USPSC-Cap3-Desenvolvimento}
\include{cap/USPSC-Cap4-Resultados}
\include{cap/USPSC-Cap5-Conclusao}
...
% ----------------------------------------------------------
\bibliography{_USPSC-modelo-references}
