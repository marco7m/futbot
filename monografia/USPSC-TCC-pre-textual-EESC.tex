...
\autorficha{Mijam, Marco Aurélio Martins}
\autorabr{MIJAM, M. A. M.}
...
\orientador{Prof. Dr. Eduardo do Valle Simoes}
...
\orientadorcorpoficha{orientador Eduardo do Valle Simoes}
%\orientadorficha{Rodrigues, Elisa Gon\c{c}alves, orient. II. Serqueira, Jo\~ao Alves, co-orient}
\orientadorficha{Simões, Eduardo do Valle, orient}
