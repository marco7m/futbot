...
void GoalKick::mostra(){
        ...
        *_tempo = *_tempo+10;
        ...
        // Saida de dados
        _robo[0].setVel(output.ptr[0]);
        _robo[0].setVelAng(output.ptr[1]);

}

QPointF GoalKick::getQuinas(robovss rob, int l){ // 0 - top dir; 1 - bai dir; 2 - bai esq; 3 - top esq
    QPointF quina;
    if(l == 0){
