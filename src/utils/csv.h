...
public:
    ...
    static void SaveData(std::vector<std::vector<std::string> > all_data, std::string name, char sc); //OLD
    static void SaveData(std::vector<std::vector<double> > all_data, std::string name, char sc); //OLD
    static std::vector<std::vector<double> > GetDoubleData(std::string name); //OLD
    static std::vector<std::vector<std::string> > GetStringData(std::string name); //OLD
};
