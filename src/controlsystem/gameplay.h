...
public:
    ...
    double fast_one_with_one_dead_robot(NeuralNetwork* nn, double play_time, double block_pos_x, double block_pos_y, double target_pos_x, double target_pos_y, std::string file_name = "");
